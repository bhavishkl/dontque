  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <Navbar className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm shadow-sm">
        <NavbarBrand>
          <Link href="/" className="text-2xl font-bold text-black dark:text-white">QueueSmart</Link>
        </NavbarBrand>
        <NavbarContent className="hidden sm:flex gap-4" justify="center">
          <NavbarItem>
            <Link href="#features" className="text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white">Features</Link>
          </NavbarItem>
          <NavbarItem>
            <Link href="#how-it-works" className="text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white">How It Works</Link>
          </NavbarItem>
          <NavbarItem>
            <Link href="#pricing" className="text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white">Pricing</Link>
          </NavbarItem>
          <NavbarItem>
            <Link href="#case-studies" className="text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white">Case Studies</Link>
          </NavbarItem>
          <NavbarItem>
            <Link href="#faq" className="text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white">FAQ</Link>
          </NavbarItem>
        </NavbarContent>
      ...
      <main>
        ...
        <section id="features" className="py-20 bg-gray-50 dark:bg-gray-900">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-black dark:text-white">Why Choose QueueSmart?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="bg-white dark:bg-gray-800">
                <CardBody className="text-center">
                  <div className="text-4xl mb-4">⏱️</div>
                  <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">AI-Powered Queue Optimization</h3>
                  <p className="text-gray-600 dark:text-gray-300">Our advanced AI algorithms dynamically adjust queue flow, minimizing wait times and maximizing efficiency.</p>
                </CardBody>
              </Card>
              <Card className="bg-white dark:bg-gray-800">
                <CardBody className="text-center">
                  <div className="text-4xl mb-4">📱</div>
                  <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">Seamless Virtual Queues</h3>
                  <p className="text-gray-600 dark:text-gray-300">Allow customers to join queues remotely and receive real-time updates through our intuitive mobile app.</p>
                </CardBody>
              </Card>
              <Card className="bg-white dark:bg-gray-800">
                <CardBody className="text-center">
                  <div className="text-4xl mb-4">📊</div>
                  <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">Predictive Analytics</h3>
                  <p className="text-gray-600 dark:text-gray-300">Gain valuable insights into customer behavior and optimize your service with our advanced analytics dashboard.</p>
                </CardBody>
              </Card>
            </div>
          </div>
        ...
        <section id="how-it-works" className="py-20">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-black dark:text-white">How QueueSmart Works</h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <ol className="space-y-6">
                  <li className="flex items-start">
                    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-black dark:bg-white text-white dark:text-black font-bold mr-4">1</span>
                    <div>
                      <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">Set Up Your Smart Queue</h3>
                      <p className="text-gray-600 dark:text-gray-300">Customize your queue settings and integrate with your existing systems in minutes.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-black dark:bg-white text-white dark:text-black font-bold mr-4">2</span>
                    <div>
                      <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">AI-Powered Queue Management</h3>
                      <p className="text-gray-600 dark:text-gray-300">Our AI continuously optimizes your queue, adjusting to real-time conditions and predicting peak times.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-black dark:bg-white text-white dark:text-black font-bold mr-4">3</span>
                    <div>
                      <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">Enhance Customer Experience</h3>
                      <p className="text-gray-600 dark:text-gray-300">Provide real-time updates, personalized wait times, and virtual queue options to delight your customers.</p>
                    </div>
                  </li>
                </ol>
              </div>
        ...
        <section id="pricing" className="py-20 bg-gray-50 dark:bg-gray-900">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-black dark:text-white">Simple, Transparent Pricing</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <Card key={index} className="bg-white dark:bg-gray-800">
                  <CardBody className="p-6">
                    ...
                    <p className="text-3xl font-bold mb-4 text-black dark:text-white">{plan.price}<span className="text-sm font-normal text-gray-600 dark:text-gray-300">/month</span></p>
                    <ul className="space-y-2 mb-6">
                      {plan.features.map((feature, i) => (
                        <li key={i} className="flex items-center text-gray-600 dark:text-gray-300">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-black dark:text-white mr-2" viewBox="0 0 20 20" fill="currentColor">
        ...
        <section id="case-studies" className="py-20">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-black dark:text-white">Success Stories</h2>
        ...
        <section id="faq" className="py-20 bg-gray-50 dark:bg-gray-900">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-black dark:text-white">Frequently Asked Questions</h2>
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div key={index}>
                  <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">{faq.q}</h3>
