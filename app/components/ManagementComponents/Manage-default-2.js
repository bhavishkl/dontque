...
import { Spinner, Button, Input, Card, CardBody, CardHeader, Chip, Switch, Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, Skeleton, Tabs, Tab } from "@nextui-org/react"
import { useApi } from '@/app/hooks/useApi'
import { useRouter } from 'next/navigation'
import { toast } from 'sonner'
import Link from 'next/link'
import { ArrowLeft, Users, Clock, TrendingUp, Settings, UserMinus, RefreshCw, Check, X, BarChart2, AlertCircle, Activity } from 'lucide-react'
...
export default function ManageDefault2({ params, queueData: initialQueueData, isLoading: initialLoading }) {
