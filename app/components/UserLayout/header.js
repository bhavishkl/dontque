...
import { Bell, X, Home, Search, Clock, History, TrendingUp, Star, Building, Users, Settings, User, LogOut, ChevronLeft, ChevronRight, ArrowLeft, ArrowRight } from 'lucide-react'
...
const menuSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/user/dashboard",
        icon: Clock,
        badge: "2" // Optional: Add badge if you want to show active queues
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        href: "/dashboard",
        icon: Building,
        show: role => role === 'business' // Optional: Conditional rendering based on user role
      },
      {
        label: "Analytics",
        href: "/dashboard/analytics",
        icon: TrendingUp,
        show: role => role === 'business'
      }
    ]
  }
];
